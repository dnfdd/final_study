...
<jsp:include page="../../layout/header.jsp" />
	...
	<!-- ===================================================================================== -->
		...
		<div class="write">
			<div>
				...
				<input type="hidden" name="ori_DURATION_END" id="endDate" value="${__BOARD__.DURATION_END}">
				<input type="hidden" name="DURATION_END" id="durationEnd" value="">
				<div>
					내용: <input type="text" name="REVIEW" placeholder="${__BOARD__.REVIEW}">
					<input type="hidden" name="ori_REVIEW" value="${__BOARD__.REVIEW}">
				</div>
			</div>
							...
							<c:choose>
								...
								<li>
								    <div class="write_day_dec_list" id="result${loop.count}_${loop2.count}">
								    	<div class="dec_img"><img src="../../../resources/static/img/seoul_forest.png" alt="" style="width: 80px; height: 50px;"></div>
	...
	<script>
		...
		function sendData() {
			...
			if($('input[name="DURATION_START"]').val() != null && $('input[name="DURATION_START"]').val() != ""){
				var durationStartStr = $('input[name="DURATION_START"]').val();
			} else {
				var durationStartStr = $('input[name="ori_DURATION_START"]').val();
			}
			var durationStart = new Date(durationStartStr);
			
			if($('input[name="DURATION_END"]').val() != null && $('input[name="DURATION_END"]').val() != ""){
				var durationEndStr = $('input[name="DURATION_END"]').val();
			} else {
				var durationEndStr = $('input[name="ori_DURATION_END"]').val();
			}
			var durationEnd = new Date(durationEndStr);
			
			if($('input[name="REVIEW"]').val() != null && $('input[name="REVIEW"]').val() != ""){
				var review = $('input[name="REVIEW"]').val();
			} else {
				var review = $('input[name="ori_REVIEW"]').val();
			}
